...
_FOOD_AVOID_GROUPS: tuple[tuple[tuple[str, ...], str], ...] = (
    (
        ("海产品", "海鲜", "虾", "蟹", "螃蟹", "大虾", "虾仁", "扇贝", "生蚝",
         ...
         # 组合词（用户常见说法）：虾蟹/鱼虾/虾贝/蟹贝 粘连时单个词不命中，需整组补充
         "虾蟹", "鱼虾", "虾贝", "蟹贝", "鱼蟹", "虾蟹贝"),
        "seafood_allergy",
    ),
